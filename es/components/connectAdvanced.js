...
_ref = {}) {
  let {
    ...
    context = ReactReduxContext
      ...
      connectOptions = _objectWithoutPropertiesLoose(_ref, _excluded);
  ...
  const wrapWithConnect = WrappedComponent => {
    ...
    function ConnectFunction(props) {
      ...
      const [[previousStateUpdateResult], forceComponentUpdateDispatch] = useReducer(storeStateUpdatesReducer, // @ts-ignore
